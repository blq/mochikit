...
def GetDepsLine(dep):
  ...
  return 'goog.addDependency(\'%s\', %s, %s);' % (
      os.path.normpath(dep.filename).replace("\\", "/"), dep.provides, dep.requires) # patched. see issue: http://code.google.com/p/closure-library/issues/detail?id=99&can=1&q=calcdeps
